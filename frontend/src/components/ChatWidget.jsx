...
// ─────────────────────────────────────────────────────────────
// Audio Player Component for TTS Spoken Responses (Bulbul v3)
// ─────────────────────────────────────────────────────────────
      ...
      elements.push(
        <div
          ...
          className={`font-heading font-bold text-gov-900 mt-2 mb-1 ${
            level <= 2
              ? 'text-xs font-bold border-b border-slate-100 pb-1'
              : 'text-xs text-charcoal-900 font-semibold'
          }`}
        >
      ...
      {open && (
        ...
        >
          ...
          <main
            ...
            aria-live="polite"
          >
            {/* Welcome Message Component (Always available at top or initial guided state) */}
                ...
                <div key={index} className="flex items-start gap-2.5">
                  ...
                  <div className="max-w-[90%] space-y-2">
                    ...
                    <div className="bg-white border border-slate-200/90 rounded-2xl rounded-tl-sm p-3.5 text-xs text-charcoal-800 shadow-subtle leading-relaxed">
                      ...
                      {/* Audio Player Button (Bulbul v3 TTS) */}
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-colors flex-shrink-0 focus:outline-none ${
                    isRecording
                      ...
                      : 'text-slate-500 hover:text-gov-700 hover:bg-gov-50'
                  }`}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                    <path
